...
module R4gl
  module Generators
    class ScaffoldGenerator < Base
      ...
      class_option :skip_controller, :desc => 'Don\'t generate controller, helper, stylesheet, javascript, or views.', :type => :boolean
      class_option :skip_helper,     :desc => 'Don\'t generate helper.', :type => :boolean
      class_option :skip_javascript, :desc => 'Don\'t generate javascript.', :type => :boolean
      class_option :skip_stylesheet, :desc => 'Don\'t generate stylesheet.', :type => :boolean
      class_option :skip_locales,    :desc => 'Don\'t generate associated locales.', :type => :boolean
      ...
      def create_controller
        unless options.skip_controller?
          ...
          unless options.stylesheet?
            template 'assets/stylesheet.rb', "app/assets/stylesheets/#{plural_name}.css.scss"
          end

          unless options.skip_javascript?
            template 'assets/javascript.rb', "app/assets/javascripts/#{plural_name}.js.coffee"
          end

          unless options.skip_locales?
            template 'locales/view.erb', "config/locales/views/#{plural_name}/en.yml"
          end
